      ...
      <div class="col-lg-1"></div>
        ...
        <div class="col-lg-6">
            ...
            <div class="login">
                ...
                <a href="index.php?id"> <button class="buttonn" id="submit" name="submit" onclick="ValidateEmail(document.form1.email); ValidatePass(document.form1.pass)">Login</button> </a>
                
                </form>
                <a href="index.php?id"> <button class="buttonn" id="back" name="submit">Back</button> </a>
